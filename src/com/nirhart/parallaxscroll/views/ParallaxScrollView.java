...
//		TextView layout = (TextView) findViewById(R.id.menubar2);
...
//	}
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		System.out.println(Integer.toString(l) + " " + Integer.toString(t) + " " + Integer.toString(oldl) + " " + Integer.toString(oldt));
